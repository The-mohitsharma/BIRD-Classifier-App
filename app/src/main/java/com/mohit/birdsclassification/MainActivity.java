...
public class MainActivity extends AppCompatActivity implements CameraFragment.CameraListener{
    ...
    String[] birdRecognised; //  used for list of bird recognised.
                ...
                if (result.getResultCode() == Activity.RESULT_OK) {
                    ...
                    if (data!=null){
                        ...
                        if (data.getClipData() != null) {
                            ...
                            birdRecognised=new String[data.getClipData().getItemCount()];
                            ...
                            try {
                                birdRecognised=new String[0];
                                timeElapsed=new String[0];
                                batteryLevel=new String[0];
    ...
    private void imageRender(Bitmap[] urls) { // loop through all selected images recognise and send them to the adapter.
        ...
        binding.vpData.setAdapter(new ProcessedImageAdapter(urls,birdRecognised, timeElapsed, batteryLevel,getApplicationContext()));
    ...
    public void recognise(Bitmap bitmap, int position){ // tensorflow apis for model recognition.
        try {
            ...
            birdRecognised[position]= data.split(" ")[0];
